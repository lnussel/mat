// This code was autogenerated with `dbus-codegen-rust --file /usr/share/dbus-1/interfaces/org.freedesktop.machine1.Manager.xml`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
